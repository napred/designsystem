module.exports = {
  ...
  globalSetup: '<rootDir>/packages/uniprimitives/node_modules/jest-environment-puppeteer/setup',
  globalTeardown:
    '<rootDir>/packages/uniprimitives/node_modules/jest-environment-puppeteer/teardown',
  projects: [
